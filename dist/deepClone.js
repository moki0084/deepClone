...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(78),
	    ...
	    isArrayOrObject = _require.isArrayOrObject;
	...
	var deepClone = function deepClone(obj) {
	    var maxDeep = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;
	
	    var rObj = void 0;
	    if (!isArrayOrObject(obj)) {
	        rObj = obj;
	    } else {
	        var stack = new _map2.default();
	 ...
	 */
	var clone = function clone(obj, maxDeep) {
	    var stack = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : new _map2.default();
	    var deepStack = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];
	
	    var result = isArray(obj) ? [] : isObject(obj) ? {} : obj;
	
	    // checkObj circular
	    var rStack = stack.get(obj);
	    if (rStack) {
	        return rStack;
	    }
...
/***/ function(module, exports) {
	...
	var isArrayOrObject = exports.isArrayOrObject = function isArrayOrObject(obj) {
